...
up. Open the link a few minutes before you need it (before your presentation, say)
and it'll be instant from then on.
...
5. Once it's live, Render gives you a URL like `https://auroracart-dashboard.onrender.com`.
   That is your shareable dashboard link, always on, with the cold-start caveat above.
